...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    sections: [
      { slug: "ch13-01-closures", num: "১৩.১", titleEn: "Closures", titleBn: "Closure", status: "done", chapter: 13 },
      { slug: "ch13-02-iterators", num: "১৩.২", titleEn: "Processing a Series of Items with Iterators", titleBn: "Iterator দিয়ে item-গুলো process করা", status: "done", chapter: 13 },
      { slug: "ch13-03-improving-our-io-project", num: "১৩.৩", titleEn: "Improving Our I/O Project", titleBn: "আমাদের I/O Project উন্নত করা", status: "done", chapter: 13 },
      { slug: "ch13-04-performance", num: "১৩.৪", titleEn: "Performance in Loops vs. Iterators", titleBn: "Loop বনাম Iterator-এর performance", status: "done", chapter: 13 },
    ],
  },
  {
    num: 14,
    ...
    sections: [
      { slug: "ch14-01-release-profiles", num: "১৪.১", titleEn: "Customizing Builds with Release Profiles", titleBn: "Release profile দিয়ে build customize করা", status: "done", chapter: 14 },
      { slug: "ch14-02-publishing-to-crates-io", num: "১৪.২", titleEn: "Publishing a Crate to Crates.io", titleBn: "Crates.io-তে crate publish করা", status: "done", chapter: 14 },
      { slug: "ch14-03-cargo-workspaces", num: "১৪.৩", titleEn: "Cargo Workspaces", titleBn: "Cargo Workspace", status: "done", chapter: 14 },
      { slug: "ch14-04-installing-binaries", num: "১৪.৪", titleEn: "Installing Binaries with cargo install", titleBn: "cargo install দিয়ে binary install করা", status: "done", chapter: 14 },
      { slug: "ch14-05-extending-cargo", num: "১৪.৫", titleEn: "Extending Cargo with Custom Commands", titleBn: "Custom command দিয়ে Cargo extend করা", status: "done", chapter: 14 },
    ],
  },
  {
    num: 15,
    ...
    sections: [
      { slug: "ch15-01-box", num: "১৫.১", titleEn: "Using Box<T> to Point to Data on the Heap", titleBn: "Box<T> দিয়ে heap-এ data রাখা", status: "done", chapter: 15 },
      { slug: "ch15-02-deref", num: "১৫.২", titleEn: "Treating Smart Pointers Like Regular References", titleBn: "Smart Pointer-কে regular reference-এর মতো behave করানো", status: "done", chapter: 15 },
      { slug: "ch15-03-drop", num: "১৫.৩", titleEn: "Running Code on Cleanup with the Drop Trait", titleBn: "Drop trait দিয়ে cleanup-এ code চালানো", status: "done", chapter: 15 },
      { slug: "ch15-04-rc", num: "১৫.৪", titleEn: "Rc<T>, the Reference Counted Smart Pointer", titleBn: "Rc<T>: reference counted smart pointer", status: "done", chapter: 15 },
      { slug: "ch15-05-interior-mutability", num: "১৫.৫", titleEn: "RefCell<T> and the Interior Mutability Pattern", titleBn: "RefCell<T> এবং Interior Mutability pattern", status: "done", chapter: 15 },
      { slug: "ch15-06-reference-cycles", num: "১৫.৬", titleEn: "Reference Cycles Can Leak Memory", titleBn: "Reference Cycle থেকে memory leak", status: "done", chapter: 15 },
    ],
  },
  {
    num: 16,
    ...
    sections: [
      { slug: "ch16-01-threads", num: "১৬.১", titleEn: "Using Threads to Run Code Simultaneously", titleBn: "Thread দিয়ে code একসাথে চালানো", status: "done", chapter: 16 },
      { slug: "ch16-02-message-passing", num: "১৬.২", titleEn: "Using Message Passing to Transfer Data Between Threads", titleBn: "Message Passing দিয়ে thread-এর মধ্যে data পাঠানো", status: "done", chapter: 16 },
      { slug: "ch16-03-shared-state", num: "১৬.৩", titleEn: "Shared-State Concurrency", titleBn: "Shared-state concurrency", status: "done", chapter: 16 },
      { slug: "ch16-04-extensible-concurrency-sync-and-send", num: "১৬.৪", titleEn: "Extensible Concurrency with the Send and Sync Traits", titleBn: "Send এবং Sync দিয়ে concurrency বাড়ানো", status: "done", chapter: 16 },
    ],
  },
  {
    num: 17,
    ...
    sections: [
      { slug: "ch17-01-futures-and-syntax", num: "১৭.১", titleEn: "Futures and the Async Syntax", titleBn: "Future এবং Async syntax", status: "done", chapter: 17 },
      { slug: "ch17-02-concurrency-with-async", num: "১৭.২", titleEn: "Applying Concurrency with Async", titleBn: "Async দিয়ে concurrency apply করা", status: "done", chapter: 17 },
      { slug: "ch17-03-more-futures", num: "১৭.৩", titleEn: "Working With Any Number of Futures", titleBn: "একাধিক Future নিয়ে কাজ", status: "done", chapter: 17 },
      { slug: "ch17-04-streams", num: "১৭.৪", titleEn: "Streams: Futures in Sequence", titleBn: "Stream: Future-এর sequence", status: "done", chapter: 17 },
      { slug: "ch17-05-traits-for-async", num: "১৭.৫", titleEn: "A Closer Look at the Traits for Async", titleBn: "Async-এর Trait-গুলোতে আরও গভীরে", status: "done", chapter: 17 },
      { slug: "ch17-06-futures-tasks-threads", num: "১৭.৬", titleEn: "Futures, Tasks, and Threads", titleBn: "Future, Task, এবং Thread", status: "done", chapter: 17 },
    ],
  },
  {
    num: 18,
    ...
    sections: [
      { slug: "ch18-01-what-is-oo", num: "১৮.১", titleEn: "Characteristics of Object-Oriented Languages", titleBn: "Object-Oriented language-এর বৈশিষ্ট্য", status: "done", chapter: 18 },
      { slug: "ch18-02-trait-objects", num: "১৮.২", titleEn: "Using Trait Objects That Allow for Values of Different Types", titleBn: "Trait Object দিয়ে shared behavior abstract করা", status: "done", chapter: 18 },
      { slug: "ch18-03-oo-design-patterns", num: "১৮.৩", titleEn: "Implementing an Object-Oriented Design Pattern", titleBn: "একটি Object-Oriented design pattern implement করা", status: "done", chapter: 18 },
    ],
  },
  {
    num: 19,
    ...
    sections: [
      { slug: "ch19-01-all-the-places-for-patterns", num: "১৯.১", titleEn: "All the Places Patterns Can Be Used", titleBn: "Pattern কোথায় কোথায় ব্যবহার হয়", status: "done", chapter: 19 },
      { slug: "ch19-02-refutability", num: "১৯.২", titleEn: "Refutability: Whether a Pattern Might Fail to Match", titleBn: "Refutability: Pattern fail করতে পারে কিনা", status: "done", chapter: 19 },
      { slug: "ch19-03-pattern-syntax", num: "১৯.৩", titleEn: "Pattern Syntax", titleBn: "Pattern Syntax", status: "done", chapter: 19 },
    ],
  },
  {
    num: 20,
    ...
    sections: [
      { slug: "ch20-01-unsafe-rust", num: "২০.১", titleEn: "Unsafe Rust", titleBn: "Unsafe Rust", status: "done", chapter: 20 },
      { slug: "ch20-02-advanced-traits", num: "২০.২", titleEn: "Advanced Traits", titleBn: "Advanced Trait", status: "done", chapter: 20 },
      { slug: "ch20-03-advanced-types", num: "২০.৩", titleEn: "Advanced Types", titleBn: "Advanced Type", status: "done", chapter: 20 },
      { slug: "ch20-04-advanced-functions-and-closures", num: "২০.৪", titleEn: "Advanced Functions and Closures", titleBn: "Advanced Function এবং Closure", status: "done", chapter: 20 },
      { slug: "ch20-05-macros", num: "২০.৫", titleEn: "Macros", titleBn: "Macro", status: "done", chapter: 20 },
    ],
  },
  {
    num: 21,
    ...
    sections: [
      { slug: "ch21-01-single-threaded", num: "২১.১", titleEn: "Building a Single-Threaded Web Server", titleBn: "Single-Threaded Web Server বানানো", status: "done", chapter: 21 },
      { slug: "ch21-02-multithreaded", num: "২১.২", titleEn: "Turning Our Single-Threaded Server into a Multithreaded Server", titleBn: "Single থেকে Multithreaded server-এ", status: "done", chapter: 21 },
      { slug: "ch21-03-graceful-shutdown-and-cleanup", num: "২১.৩", titleEn: "Graceful Shutdown and Cleanup", titleBn: "Graceful Shutdown এবং Cleanup", status: "done", chapter: 21 },
    ],
  },
];
